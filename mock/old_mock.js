  ...
  d.fy = null;
    ...
    function update_array(newSim) {
      ...
      addToGraph(centralWord);
         ...
         var node = svg.select("g").data(nodes)
         ...
         .merge(node);
                ...
                var link = svg.select("g").data(links)
              ...
              .call(function(link) { link.transition().attr("stroke-width", d => linkScale(d.value))
                .attr("stroke", "#A8A6B3"); })
              .merge(link);
