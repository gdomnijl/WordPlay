...
d3.queue()
    ...
    //comment out end 
        ...
        var values = links.map(function(a) {
            return a.value;
        });
        // console.log(values);
        ...
        function exit_highlight() {
            ...
            if (focus_node === null) {
                ...
                if (highlight_color != "white") {
                    ...
                    link.style("stroke", function(o) {
                        return (  o.value >= 0) ? "#A8A6B3" : default_link_color
                    });
                }
            }
        }
...
console.log(data)
 ...
 g = svg.append("g");
            //Step 0: Record the first entry as the central word
            var centralWord = data[0].Source; //.Relevance[0].Source;

            //step 1: sort (deleted)

            //Step 2: Select which data rows to put into graph
            for (row of data) { //.Relevance) {
            ...
            function exit_highlight() {
                ...
                if (focus_node === null) {
                    ...
                    if (highlight_color != "white") {
                        ...
                        text.style("font-weight", "normal");
                        link.style("stroke", function(o) {
                            return ( /*isNumber(o.Similarity) && */ o.value >= 0) ? "#A8A6B3" : default_link_color
                        });
                    }
...
function dragended(d) {
 ...
 //**************Functions For Searchbox
function searchNode() {
    //find the node
    var selectedVal = document.getElementById('search2').value;
    var nodeselect = svg.selectAll(".nodes");
    if (selectedVal == "none") {
        nodeselect.style("stroke", "white").style("stroke-width", "1");
    } else {
        var selected = nodeselect.filter(function(d, i) {
