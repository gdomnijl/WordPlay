...
//PARSE STUPID STRING
/*
var uniString = "u'pancam', u'pancal', u'pancan', u'eguchii', u'\u8bd7\u6b4c', u'kiern', u'kiero', u'kalu\u0111erovac', u'gandhiya', u'kiera', u'ettien', u'geranoaetus', u'kierz', u'matala', u'prosaposin', u'polipointpress', u'quadratische', u'fowre', u'pulsnitzer', u'kiers', u'marelja', u'kitengesa', u'intsia', u'kieru', u'dutchin', u'pukeiti', u'soskovets', u'shartiya', u'kbbb', u'tenggol', u'osmera', u'den\xe9', u'gelsomino', u'rudolphus', u'b\xe9roalde', u'overtrousers', u'nighasan', u'\u010dujte', u'prototheoridae', u'dekapolitissa', u'ampedo', u'uncolonised', u'vyselok', u'sideroad', u'tashing', u'mawaly', u'burchwood', u'kurdistane', u'carlencas', u'mawala', u'denaturant', u'm\xe4rker', u'neerlanden', u'shenkin', u'buchakjian', u'miangas', u'nasswald', u'wijayawardhena', u'oberl\xe4nder', u'zobeideh', u'wijayawardhene', u'lichy', u'terceira', u'pignut', u'pignus', u'chaque', u'karamanos', u'gogugwon', u'dharmatr\u0101ta', u'arnumber', u'csuja', u'outpour', u'abudda', u'fortica', u'ghoraniyeh', u'houille', u'compae', u'tasoula', u'khedira', u'sixline', u'noggin', u'dend\u014d', u'l\xe9onor', u'daivadnyas', u'brevicollis', u'denz', u'deny', u'maycock', u'tribracteata', u'tmesiphantes', u'melanesien', u'dens', u'denr', u'arbutny', u'champagny', u'denw', u'denv', u'denu', u'dent', u'denk', u'denj', u'deni', u'denh', u'deno', u'denn', u'carrefoursa', u'acuna', u'urgals', u'denb', u'dena', u'ahiram', u'deng', u'backstabber', u'dene', u'dend', u'keilaniemi', u'bouch\xe9es', u'prostens', u'delvada', u'chrysosticta', u'whare', u'strafgericht', u'agrammatic', u'joselle', u'elfershausen', u'taguiporo', u'mappamondo', u'jillie', u'rykr'"
var r = /\\u([\d\w]{4})/gi;
uniString = uniString.replace(r, function (match, grp) {
    return String.fromCharCode(parseInt(grp, 16)); } );
uniString = unescape(uniString);
console.log(uniString);

var uniParse = uniString.split(",")
console.log(uniParse);

for (var i = 0; i < uniParse.length; i++) {
  //console.log(uniParse[i].length)
  uniParse[i] = uniParse[i].substr(3, uniParse[i].length - 4);
...
*/
 //READ FILE\
 /*
var txtFile = "vocab.txt"
var file = new File(txtFile);
file.open("r"); // open file with read access
var vocab = []
for (var line of txtFile) {
  //var v = line.split("\n");
  vocab.push(line);
}
file.close();
...
.defer(d3.csv, 'vocab.txt')
.await(function(error,data, vocab){
    console.log(vocab.map(d => d.word));
